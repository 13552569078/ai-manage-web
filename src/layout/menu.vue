<template>
  <hl-aside :class="collapse">
    <hl-group block dir="vertical" class="h-full">
      <hl-group class="index-button p-l-lg p-r-md" align="items-middle items-between" gap="var(--sm)"
        @click="handleGoHome" style="cursor: pointer">
        <span class="font-bold font-lg w-full">数智网格员</span>
      ...
      <div class="scrollable no-thumb">
        <hl-menu :default-active="defaultActive" :router="readRoute" :unique-opened="true" :collapse="isCollapse"
          @select="selectMenu">
